...
map.getView().fit([-1126037.973945, 3534516.372912, -668600.699422, 3906984.639114], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">La carte du recensement de la population pour la région Marrakech Safi (By HANSALI)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (185 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation d\'une carte coroplèthe interactive basée sur la variation de la population entre les différebtes provinces de la région Marrakech Safi selon le recensement du septembre 2024';
            }
